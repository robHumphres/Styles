...
public class ProfileFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Intialize btns
        Button closetBtn = (Button)v.findViewById(R.id.closetBtn);
        Button bioBtn = (Button)v.findViewById(R.id.bioBtn);
        Button groupsBtn =(Button)v.findViewById(R.id.groupBtn);
        Button locationBtn = (Button) v.findViewById(R.id.locationBtn);
        Button friendsBtn = (Button)v.findViewById(R.id.friendsBtn);
        Button rankingBtn = (Button)v.findViewById(R.id.rankingBtn);
    ...
    public void onClick(View view){
        switch(view.getId()){
            case R.id.closetBtn:
                ...
                break;
            default:
                Toast.makeText(getActivity(), "Btn worked", Toast.LENGTH_SHORT).show();
                break;
        }//end of switch
    }
